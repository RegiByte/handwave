...
import type { FingerName as CalibrationFingerName } from '@/core/lib/intent/matching/pinchCalibration'
import { getPinchThreshold } from '@/core/lib/intent/matching/pinchCalibration'
import { getGestureThreshold } from '@/core/lib/intent/matching/gestureCalibration'
...
export function pinch<TFinger extends FingerName>(
  ...
  const calibratedThreshold = getPinchThreshold(finger as CalibrationFingerName)
