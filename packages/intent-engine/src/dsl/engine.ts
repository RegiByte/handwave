...
import { calculateVelocity, intentKeywords, normalizedToCell } from '@handwave/intent-engine'
import type { ActiveAction, FrameSnapshot, IntentEngineConfig, Vector3 } from '@handwave/intent-engine'
...
export function processFrameV2(
  ...
  const selectedInstances = resolveInstanceConflicts(matchingInstances, config)
 ...
 */
export function resolveConflictsV2(
 ...
 */
function resolveInstanceConflicts(
